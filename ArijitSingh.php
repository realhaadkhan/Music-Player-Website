...
<head>
    ...
    <link rel="stylesheet" href="ArijitSingh_style.css">
...
<body>
    <script>
        document.addEventListener(`DOMContentLoaded`, () => {
            let allSongs = [];
            <?php
            $sql = "SELECT * FROM musics_db WHERE songArtist LIKE '%Arijit Singh%'";
            ...
            let popSongs = [];
            <?php
            $popsql = "SELECT * FROM musics_db WHERE ratings > 3 AND songArtist LIKE '%Arijit Singh%' ORDER BY ratings DESC";
    ...
    <header>
        ...
        <div class="song">
            ...
            <div class="content">
                <h1>Arijit Singh - Kesariya</h1>
                <p>Kesariya tera ishq hai piya<br>
                    Rang jaaun jo main hath lagaun<br>
                    Din beete saara teri fikr mеin<br>
