...
<body>
    <script>
        document.addEventListener(`DOMContentLoaded`, () => {
            ...
            let popSongs = [];
            <?php
            $popsql = "SELECT * FROM musics_db WHERE ratings > 3 ORDER BY ratings DESC";
    ...
    <header>
        ...
        <div class="song">
            ...
            <div class="content">
                <h1>Olivia Newton - The Promise (The Dolphin Song)</h1>
                <p>See them play in the moonlight, Watch them dance in the sun.
                    <br>They're the children of freedom, everyone.
                    <br>As they care for each other, With no question or cause, They deserved to be treasured as a
                    source of love.
                </p>
                <div class="buttons">
                    <button>Play</button>
            ...
            <div class="pop_artists">
                <div class="h4">
                    <h4>Popular Artists</h4>
                    <div class="btn_s">
                        <i class="bi bi-arrow-left-circle" id="popArtistLeft"></i>
                        <i class="bi bi-arrow-right-circle" id="popArtistRight"></i>
                    </div>
                </div>
                <div class="item">
                    <li>
                        <a href="ArijitSingh.php"><img src="popularArtistPic/ArijitSingh.jpg" alt=""></a>
                    </li>
                    <li>
                        <a href="CharliePuth.php"><img src="popularArtistPic/CharliePuth.jpg" alt=""></a>
                    </li>
                    <!-- <li>
                        <img src="authorPFPs/1.jpg" alt="">
                    </li>
                    <li>
                        <img src="authorPFPs/1.jpg" alt="">
                    </li>
